...
class TestFireflyInterface(unittest.TestCase):
    ...
    def testCreateTransactions(self):
        ...
        transactions = [
            data.Transaction(Date="2025-05-30", Deposit=-1619.25, Description="Test1", SourceAccountName="Expenses:Shopping"),
            data.Transaction(Date="2024-05-30", Deposit=-13.32, Description="Test2", SourceAccountName="Expenses:Misc"),
        ]
        ...
        self.assertEqual(transactionData["source_name"], transactions[0].SourceAccountName)
